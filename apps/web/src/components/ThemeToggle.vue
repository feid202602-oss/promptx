  ...
  <div class="space-y-4">
    <div>
      <div class="flex items-center justify-between gap-3">
        ...
        <div class="theme-muted-text rounded-sm border border-dashed border-[var(--theme-borderDefault)] bg-[var(--theme-appPanelStrong)] px-2 py-1 text-[11px]">
    ...
    <div class="space-y-4">
      <section v-for="group in themeGroups" :key="group.id" class="space-y-1.5">
        ...
        <button
          ...
          :key="theme.id"
          type="button"
          class="theme-option w-full rounded-sm border px-3 py-2 text-left transition"
