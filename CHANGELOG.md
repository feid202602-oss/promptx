...
- 收口主题系统与毛玻璃皮肤细节，修复删除确认弹窗按钮不可见、主题项冗余预览、主题名称/文案乱码等问题。
- 优化项目管理体验，修复“从执行中项目进入后所有项目都不能删除”的错误禁用逻辑。
- 修复 Codex 回复列表样式，恢复有序/无序列表 marker，并补齐嵌套列表层级样式与间距。
- 增强 Relay 稳定性与诊断能力：增加 ping/pong 心跳、超时重连、client/server 关键日志、recent events，以及本地设置页一键复制诊断信息。
